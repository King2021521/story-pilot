...
const coreStoryTextFieldSchema = z.string().min(1).max(800);
const coreStoryLoglineFieldSchema = z.string().min(1).max(180);
...
export const CoreStoryFieldCompletionOutputSchema = z.object({
  fields: z.object({
